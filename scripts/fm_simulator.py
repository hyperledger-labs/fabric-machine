...
#         tx_ends = tx_fifo.popleft()
#         fs.append(threads.submit(verify_ends, config, i, tx_ends))
#     futures.wait(fs)

#     end_time = time.perf_counter()
#     print('block{0} {1:0.4f}ms'.format(block_num, (end_time - start_time) * 1000))
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Adhoc simulator to estimate block validation latency in block_processor module (of Blockchain Machine).')
